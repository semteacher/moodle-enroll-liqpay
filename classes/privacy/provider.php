    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table(
                ...
                [
                    ...
                    'amount'              => 'privacy:metadata:enrol_liqpay:enrol_liqpay:amount',
                    'currency'            => 'privacy:metadata:enrol_liqpay:enrol_liqpay:currency',
                    'amount_credit'       => 'privacy:metadata:enrol_liqpay:enrol_liqpay:amount_credit',
                    'currency_credit'     => 'privacy:metadata:enrol_liqpay:enrol_liqpay:currency_credit',
                    'commission_credit'   => 'privacy:metadata:enrol_liqpay:enrol_liqpay:commission_credit',
                    'amount_debit'        => 'privacy:metadata:enrol_liqpay:enrol_liqpay:amount_debit',
                    'currency_debit'      => 'privacy:metadata:enrol_liqpay:enrol_liqpay:currency_debit',
                    'commission_debit'    => 'privacy:metadata:enrol_liqpay:enrol_liqpay:commission_debit',
                    'payment_status'      => 'privacy:metadata:enrol_liqpay:enrol_liqpay:payment_status',
                    'end_date'            => 'privacy:metadata:enrol_liqpay:enrol_liqpay:end_date',
                    'create_date'         => 'privacy:metadata:enrol_liqpay:enrol_liqpay:create_date',
                    'acq_id'              => 'privacy:metadata:enrol_liqpay:enrol_liqpay:acq_id',
                    'payment_id'          => 'privacy:metadata:enrol_liqpay:enrol_liqpay:payment_id',
                    'liqpay_order_id'     => 'privacy:metadata:enrol_liqpay:enrol_liqpay:liqpay_order_id',
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($liqpayrecords as $liqpayrecord) {
            ...
            $transaction = (object) [
                ...
                'amount'              => $liqpayrecord->amount,
                'currency'            => $liqpayrecord->currency,
                'amount_credit'       => $liqpayrecord->amount_credit,
                'currency_credit'     => $liqpayrecord->currency_credit,
                ...
                'commission_debit'    => $liqpayrecord->commission_debit,
                'paytype'             => $liqpayrecord->paytype,
                'action'              => $liqpayrecord->action,
                'payment_status'      => $liqpayrecord->payment_status,
                'end_date'            => $liqpayrecord->end_date,
                'create_date'         => $liqpayrecord->create_date,
                'acq_id'              => $liqpayrecord->acq_id,
                'payment_id'          => $liqpayrecord->payment_id,
                'liqpay_order_id'     => $liqpayrecord->liqpay_order_id,

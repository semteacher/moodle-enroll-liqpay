    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table(
                ...
                [
                    ...
                    'memo'                => 'privacy:metadata:enrol_liqpay:enrol_liqpay:memo',
                    'tax'                 => 'privacy:metadata:enrol_liqpay:enrol_liqpay:tax',
                    'option_selection1_x' => 'privacy:metadata:enrol_liqpay:enrol_liqpay:option_selection1_x',
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($liqpayrecords as $liqpayrecord) {
            ...
            $transaction = (object) [
                ...
                'memo'                => $liqpayrecord->memo,
                'tax'                 => $liqpayrecord->tax,

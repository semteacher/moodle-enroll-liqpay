...
$string['liqpayaccepted'] = 'PayPal payments accepted';
...
$string['privacy:metadata:enrol_liqpay:enrol_liqpay'] = 'Information about the PayPal transactions for PayPal enrolments.';
$string['privacy:metadata:enrol_liqpay:enrol_liqpay:business'] = 'Email address or PayPal account ID of the payment recipient (that is, the merchant).';
...
$string['privacy:metadata:enrol_liqpay:enrol_liqpay:memo'] = 'A note that was entered by the buyer in PayPal website payments note field.';
...
$string['privacy:metadata:enrol_liqpay:enrol_liqpay:payment_type'] = 'Holds whether the payment was funded with an eCheck (echeck), or was funded with PayPal balance, credit card, or instant transfer (instant).';
...
$string['privacy:metadata:enrol_liqpay:enrol_liqpay:receiver_id'] = 'Unique PayPal account ID of the payment recipient (i.e., the merchant).';
$string['privacy:metadata:enrol_liqpay:enrol_liqpay:tax'] = 'Amount of tax charged on payment.';
$string['privacy:metadata:enrol_liqpay:enrol_liqpay:timeupdated'] = 'The time of Moodle being notified by PayPal about the payment.';
...
$string['privacy:metadata:enrol_liqpay:liqpay_com'] = 'The PayPal enrolment plugin transmits user data from Moodle to the PayPal website.';

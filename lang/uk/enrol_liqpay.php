...
$string['publickey'] = 'Публічний ключ LiqPay';
$string['publickey_desc'] = 'Публічний ключ для Вашого бізнес-акаунту у LiqPay';
$string['privatekey'] = 'Приватинй ключ LiqPay';
$string['privatekey_desc'] = 'Приватинй ключ для Вашого бізнес-акаунту у LiqPay';
...
$string['enrolperiod'] = 'Тривалість зарахування';
...
$string['enrolperiod_help'] = 'Тривалясть часу протягом якого статус зарахування буде дійсним, починаючи від моменту зарахування. Якщо вимкнено - тривалість зарахування не буде обмежуватися в часі.';
...
$string['errdisabled'] = 'Плагін зарахування через LiqPay вимкнений і не буде обробляти сповіщення про оплату.';
...
$string['expiredaction_help'] = 'Виберіть дію що буде виконана якщо термін зарахування добігає кінця. Врахуйте, що дані користувачів та їх налаштування буде видаленно при відрахуванні з курсу.';

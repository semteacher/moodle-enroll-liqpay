...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('enrol_liqpay/publickey', get_string('publickey', 'enrol_liqpay'), get_string('publickey_desc', 'enrol_liqpay'), '', PARAM_ALPHANUMEXT));

    $settings->add(new admin_setting_configtext('enrol_liqpay/privatekey', get_string('privatekey', 'enrol_liqpay'), get_string('privatekey_desc', 'enrol_liqpay'), '', PARAM_ALPHANUMEXT));
